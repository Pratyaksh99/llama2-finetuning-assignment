...
CS5242 Neural Networks and Deep Learning - Assignment 7
...
class Dolly15kDatasetProcessor:
    ...
    def load_and_split_dataset(self):
        """
        Load Dolly-15k dataset, filter empty responses, and split into train/val/test.
        ...
        # Split the remaining 20% into validation and test (50-50)
...
class LLaMA2LoRATrainer:
    """Handles LLaMA-2-7B model loading, LoRA configuration, and training."""
    
    def __init__(
        self,
        model_name: str = "meta-llama/Llama-2-7b-hf",
        use_4bit: bool = True,
        output_dir: str = "./llama2-dolly-lora"
    ):
    ...
    def load_model_and_tokenizer(self):
        """
        Load LLaMA-2-7B model and tokenizer with optional 4-bit quantization.
        """
    ...
    def configure_lora(
        ...
        if target_modules is None:
            # Default target modules for LLaMA-2
